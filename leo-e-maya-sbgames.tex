...
carla@dcc.ufrj.br}
\and
\IEEEauthorblockN{Geraldo B. Xexéo}
\IEEEauthorblockA{\textit{Prog. de Engenharia e Sistemas de Informação} \\
\textit{Departamento de Ciência da Computação}\\
\textit{COPPE/UFRJ e IM/UFRJ}\\
Rio de Janeiro, Brasil \\
gxexeo@cos.ufrj.br}
}
